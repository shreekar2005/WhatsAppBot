...
4. **Owner Control Group:** A specific WhatsApp group ("Bantu-Control-House") acts as a control room to wake/sleep the bot, update status, or add facts commands.
...
```json
{
  "owner_name": "Shreekar",
  "agent_name": "Bantu",
  "owner_group_name": "Bantu-Control-House",
...
* **Important:** Name the group exactly **`Bantu-Control-House`** (or whatever you set in `agent_config.json`).
...
#### Owner Commands (In "Bantu-Control-House" Group chat)
