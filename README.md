...
4. **Owner Control Group:** A specific WhatsApp group ("Agent-Bantu-Control") acts as a control room to wake/sleep the bot, update status, or add facts commands.
...
```json
{
  "owner_name": "Shreekar",
  "agent_name": "Bantu",
  "owner_group_name": "Agent-Bantu-Control",
...
* **Important:** Name the group exactly **`Agent-Bantu-Control`** (or whatever you set in `agent_config.json`).
...
#### Owner Commands (In "Agent-Bantu-Control" Group chat)
